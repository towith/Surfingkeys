            ...
            /*if(enable_lasttabback_integration)
  {
      ...
      function()
      {
        ...
        window.clearTimeout(tabtiles_reset_started_timerid);*/
                    ...
                    tabtiles_checkTileSize(tabtiles_keyboardFocus, true, undefined, undefined,
                        function () {
                            tabtiles_prepareTooltip(show_tabtile, true, true);
                        });
                }
            }
        ...
        window.clearTimeout(tabtiles_reset_started_timerid);*/
            ...
            function tabtiles_text_onmouseover() {
                ...
                else if (event.target.tabtiles_ownertile)
                    sel_tabtile = event.target.tabtiles_ownertile;
                else if (event.target.parentElement.tabtiles_id)
            ...
            function tabtiles_createTile_createComponents() {
                ...
                newtile.onselectstart = function () {
                    return false;
                };
      ...
      newtile.tabtiles_text.style.color = 'transparent';
                ...
                if (startsWith(tab.url.toLowerCase(), 'https://') && !isSelected) {
                    ...
                    newtile.tabtiles_title = tabtiles_tooltip_clip(tab.title, 6) + '';
                } else {
                    ...
                    else if ((tab.url == 'http://' + tab.title) || (tab.url == 'https://' + tab.title) || (tab.url == 'ftp://' + tab.title)) {
            ...
            function tabtiles_prepareTooltip(tabtile_elem, showit, forcePositioning) {
                ...
                if (!tabtiles_tooltip) {
                    ...
                    if (!tabtiles_tooltip) {
                        ...
                        tabtiles_tooltip.onmousedown = function () {
                            tabtiles_mousedown_overtile = true;
                        };
                        tabtiles_tooltip.onselectstart = function () {
                            return false;
                        };
                        tabtiles_tooltip.onmouseover = function () {
                            tabtiles_mouseovertooltip = true
                        };
                        tabtiles_tooltip.onmouseout = function () {
                            tabtiles_mouseovertooltip = false
                        };
            ...
            function tabtiles_onmousedown(override) {
                if (event.target) {
                    ...
                    else if (event.target.tabtiles_id)
                        sel_tabtile = event.target;
                    else if (event.target.tabtiles_ownertile)
                        sel_tabtile = event.target.tabtiles_ownertile;
